...
final class CategoriaControllerUsuario extends AbstractController
{
    ...
    {
        $nombre = $request->query->get('nombre'); // <-- lee el valor del input
        $categorias = $categoriaRepository->findByNombreParcial($nombre);

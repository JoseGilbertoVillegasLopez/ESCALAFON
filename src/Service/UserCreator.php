...
class UserCreator
{
    ...
    * @param UserPasswordHasherInterface    $passwordHasher   Hashea contraseñas según la configuración del proyecto (Argon2id, bcrypt, etc.).
     * @param PasswordGenerator          $asignadorRol     Determina el rol del usuario según su puesto.
     */
     ...
     *
     * @param  $personal La entidad Personal recién creada.
     * @return void
     */
    public function createFromPersonal(InformacionPersonal $personal): void
    {
        // 1️⃣ Crear nueva entidad Usuario y vincularla con el Personal
        $usuario = new Usuario();
        $usuario->setTrabajador($personal);
